    ...
    return (
        <section className="py-24 bg-zinc-50">
            <div className="container mx-auto px-4 max-w-3xl">
                <FadeIn direction="up" className="text-center mb-12 space-y-4">
                ...
                <FadeInStagger>
                    <Accordion type="single" collapsible className="w-full space-y-4">
                        {faqs.map((faq, i) => (
                            <FadeIn key={i}>
                                <AccordionItem value={`item-${i}`} className="bg-white border border-zinc-200 rounded-xl px-4 shadow-sm hover:shadow-md transition-all">
