    ...
    return (
        <section className="py-24 bg-white overflow-hidden">
            <div className="container mx-auto px-4">
                ...
                <FadeInStagger className="flex flex-col md:flex-row gap-6 justify-center">
                    {reviews.map((review, i) => (
                        <FadeIn key={i} className="md:w-1/3">
                            <Card className="bg-zinc-50 border-zinc-100 hover:shadow-xl transition-all duration-300 hover:-translate-y-2 h-full">
